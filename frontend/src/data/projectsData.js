const baseProjects = [
 ...
 description: 'A calm and inviting living space with a minimalist approach and natural tones.',
 ...
 subCategory: 'kitchen',
 description: 'A functional kitchen designed with warm wood finishes and smart storage solutions.',
 ...
 subCategory: 'bedroom',
 description: 'A serene bedroom retreat with elegant textures and soft ambient lighting.',
 ...
 filterCategory: 'residential',
 subCategory: 'living-dining',
 description: 'A sophisticated dining space perfect for family gatherings and entertaining.',
 image: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?auto=format&fit=crop&w=1920&q=80'
 },
 {
 id: '05',
 ...
 description: 'A modern lounge area designed to inspire collaboration and comfort.',
 ...
 filterCategory: 'commercial',
 subCategory: 'commercial',
 description: 'A luxurious lobby design that creates a stunning first impression.',
 ...
 filterCategory: 'residential',
 subCategory: 'living-dining',
 description: 'An open-concept layout that enhances flow and maximizes natural light.',
 ...
 filterCategory: 'bedroom',
 subCategory: 'bedroom',
 description: 'A contemporary bedroom with a perfect balance of style, comfort and functionality.',
 image: 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&w=1920&q=80'
 },
 {
 id: '09',
 ...
 filterCategory: 'kitchen',
 subCategory: 'kitchen',
 description: 'A sleek kitchen with premium finishes and high-end appliances.',
 ...
 filterCategory: 'commercial',
 subCategory: 'commercial',
 description: 'A high-end retail space designed to elevate the brand experience.',
 ...
 description: 'A relaxing bathroom retreat with spa-like finishes and natural elements.',
 ...
 filterCategory: 'residential',
 subCategory: 'living-dining',
 description: 'A complete home interior with cohesive design and refined details.',
 image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1920&q=80'
 }
];

// Helper to generate dynamic before/after and gallery images based on subCategory
export const projectsData = baseProjects.map(project => {
 let beforeImg = 'https://images.unsplash.com/photo-1574359411659-15573a27fd0c?auto=format&fit=crop&w=800&q=80';
 let afterImg = project.image; // Use the main image as 'after' preview

 // Default gallery (Living / Generic)
 let galleryImages = [
 ...
 beforeImg = 'https://images.unsplash.com/photo-1588854337236-6889d631faa8?auto=format&fit=crop&w=800&q=80'; // old kitchen
 galleryImages = [
 ...
 beforeImg = 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=800&q=80'; // empty bedroom
 galleryImages = [
 ...
 beforeImg = 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=800&q=80'; // empty office
 galleryImages = [
